...
},{"./vendor/jquery.ui.widget":2,"jquery":5}],2:[function(require,module,exports){
...
var data_sets = [];
var data_base_path = "data/"+$lti_id+"/"+$user_id+"/";
module.exports = {
...
function renderData(){
  ...
  var remaining = data_sets.length;

  $.each(data_sets, function(ind, filename){
      d3.csv(data_base_path+filename, function(error,data){
  ...
  function renderGraph() {
   // … do something with rows1 and rows2 here …
        console.log(current_x_axis_max);
        console.log(current_y_axis_max);

      $.each(data_sets, function(ind, obj){

        renderGraphWithDataName(obj);
